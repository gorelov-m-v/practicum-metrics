...
// UpdateMetricsResponse is an empty success response.
...
const file_internal_proto_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB2Z0github.com/user/practicum-metrics/internal/protob\x06proto3"
