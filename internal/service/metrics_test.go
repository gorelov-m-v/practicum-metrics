...
func TestMetricsService_UpdateGauge(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !tt.wantErr {
				value, exists := service.GetGauge(ctx, tt.metricName)
				if !exists {
...
func TestMetricsService_UpdateCounter(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !tt.wantErr {
				value, exists := service.GetCounter(ctx, tt.metricName)
				if !exists {
...
func TestMetricsService_GetAllGauges(t *testing.T) {
	...
	service.UpdateGauge(ctx, "gauge3", 30.5)

	gauges := service.GetAllGauges(ctx)
...
func TestMetricsService_GetAllCounters(t *testing.T) {
	...
	service.UpdateCounter(ctx, "counter3", 30)

	counters := service.GetAllCounters(ctx)
...
func TestMetricsService_UpdateCounter_Accumulation(t *testing.T) {
	...
	service.UpdateCounter(ctx, "accumulator", 30)

	value, exists := service.GetCounter(ctx, "accumulator")
	if !exists {
...
func TestMetricsService_UpdateGauge_Overwrite(t *testing.T) {
	...
	service.UpdateGauge(ctx, "temperature", 30.0)

	value, exists := service.GetGauge(ctx, "temperature")
	if !exists {
...
func TestMetricsService_SaveIfNeeded_WithAsyncPersister(t *testing.T) {
	...
	value, exists := store.GetCounter(ctx, "TestCounter")
	if !exists {
...
func TestMetricsService_SaveIfNeeded_NoPersister(t *testing.T) {
	...
	err = service.UpdateCounter(ctx, "TestCounter", 50)
	if err != nil {
		t.Errorf("UpdateCounter with no persister should not fail: %v", err)
	}

	value, exists := service.GetGauge(ctx, "TestMetric")
